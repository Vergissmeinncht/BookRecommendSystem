...
public class BookDaoImpl extends SqlSessionDaoSupport implements BookDao {
	...
	@Override
	public ArrayList<Book> selectBookByName(String bookName) {
		@SuppressWarnings("unchecked")
		ArrayList<Book> ans = (ArrayList<Book>) this.getSqlSession()
				.selectList(BOOK_RECOMMEND_RESULT_NAMESPACE + "selectBookByName", bookName);
        return ans;
	}

	@Override
	public ArrayList<NCFRecommendResult> selectNCFRecommendResultsByUserId(Integer userId) {
		@SuppressWarnings("unchecked")
		ArrayList<NCFRecommendResult> ans = (ArrayList<NCFRecommendResult>) this.getSqlSession()
				.selectList(USER_NAMESPACE+"selectNCFRecommendResultByUserId",userId);
		return ans;
	}
