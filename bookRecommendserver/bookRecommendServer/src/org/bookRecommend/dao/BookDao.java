...
public interface BookDao {
	...
	public final static String BOOK_NAMESPACE = "org.bookRecommend.mapper.BookMapper.";
	public final static String USER_NAMESPACE = "org.bookRecommend.mapper.UserMapper.";
	public final static String BOOK_CLASSIFY_TWO_NAMESPACE = "org.bookRecommend.mapper.BookClassifyTwoMapper.";
	public final static String USER_RECOMMEND_RESULT_NAMESPACE = "org.bookRecommend.mapper.UserRecommendResultmapper.xml.";
	public final static String BOOK_RECOMMEND_RESULT_NAMESPACE = "org.bookRecommend.mapper.BookRecommendResultMapper.xml.";
	...
	ArrayList<Book> selectBookByName(String bookName);

	ArrayList<NCFRecommendResult> selectNCFRecommendResultsByUserId(Integer userId);
}
